        ...
        if (empty($comments)) {
            ...
            foreach ($comments as $comment) {
                ...
                if (isset($_SESSION['user'])) {
                    ...
                    echo '  <div><a class="submit" href="index.php?action=deleteComment&id=' . $comment->getId() . '" onclick="return confirm(\'' . $confirmationMessage . '\');">Supprimer</a></div>';
                }
                echo '</li>';
            }               
            echo '</ul>';
