    ...
    <main>
        ...
        <div class="contentb">
            ...
            <div class="book-details fifty">
                ...
                <input type="author" name="author" id="author" required value="<?= Utils::format($book->getAuthor())?>">
                <label for="text">Commentaire</label>
                <textarea name="content" id="content" required rows="25" cols="50"><?= Utils::format($book->getContent())?></textarea>
                <label for="available">Disponibilité</label>
                <select name="available" id="available" required >
                <?php if($book->getAvailable()){?>
                    <option value="1" >Disponible</option>
                    <option value="0">Non dispo</option><?php } else{?>
                ...
                <br>
                <button type="submit" class="btn light">Valider</button>
            </form>
            </div>
        </div>
    </main>
